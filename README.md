...
XISD Image Library for Swift.

This library provides a simple interface to read XISF files in Swift.
...
The Xcode project (`SwiftXISF.xcodeproj`) is also provided for development.
